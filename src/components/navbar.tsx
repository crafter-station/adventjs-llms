    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/20 bg-brand-red-dark">
      <div className="mx-auto flex h-14 max-w-[1600px] items-center justify-between px-4 md:px-0">
        <div className="flex h-full">
          <Link
            href="/"
            className="flex items-center gap-2 border-r border-white/20 px-4 text-sm font-bold uppercase tracking-widest text-brand-beige transition-colors hover:bg-brand-red md:px-6"
          >
            LLM Battle
          </Link>
        </div>
